...
(**
    Functions for parsing apex programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a apex program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.parser_output, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a apex program from a file into a typed OCaml CST.
